...
export function UserBadge({ user, onLogout }: UserBadgeProps) {
  ...
  return (
    <Popover>
      <PopoverTrigger
        className="group flex cursor-pointer items-center gap-2.5 rounded-xl border border-border bg-muted/60 p-1 text-foreground shadow-2xs transition-colors hover:bg-muted focus-visible:ring-2 focus-visible:ring-ring sm:px-2 sm:py-1.5"
