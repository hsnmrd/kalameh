...
import { Clock, Edit2, Eye, KeyRound, MoreVertical, Trash2 } from "lucide-react"
...
interface UseTeachersTableColumnsOptions {
...
export function useTeachersTableColumns({
  onViewProfile,
  onEdit,
  onManageAvailability,
  onResetPassword,
  onDelete,
}: UseTeachersTableColumnsOptions) {
  const t = useTranslations("teachers")

  return React.useMemo<ColumnDef<TeacherDto>[]>(
    () => [
      {
        accessorKey: "name",
        header: t("table.name"),
