...
export const PERMISSIONS = {
  ...
  // Operating Phases
  MANAGE_OPERATING_PHASES: "operating_phases:manage",
  VIEW_OPERATING_PHASES: "operating_phases:view",
  ...
  // Classrooms
  MANAGE_CLASSROOMS: "classrooms:manage",
  VIEW_CLASSROOMS: "classrooms:view",
...
export const PERMISSION_MODULES: PermissionModule[] = [
  ...
  },
  {
    ...
    permissions: [
      {
        key: "MANAGE_OPERATING_PHASES",
        permission: PERMISSIONS.MANAGE_OPERATING_PHASES,
      },
      {
        key: "VIEW_OPERATING_PHASES",
  ...
  },
  {
    id: "classrooms",
    permissions: [
      { key: "MANAGE_CLASSROOMS", permission: PERMISSIONS.MANAGE_CLASSROOMS },
      { key: "VIEW_CLASSROOMS", permission: PERMISSIONS.VIEW_CLASSROOMS },
    ],
  },
  {
    id: "users",
  ...
  },
  {
    id: "teachers",
    permissions: [
      { key: "MANAGE_TEACHERS", permission: PERMISSIONS.MANAGE_TEACHERS },
      { key: "VIEW_TEACHERS", permission: PERMISSIONS.VIEW_TEACHERS },
    ],
  },
  {
    id: "students",
...
export const DEFAULT_ROLE_PERMISSIONS = {
  ...
  [ROLES.ADMIN]: [
    ...
    PERMISSIONS.MANAGE_OPERATING_PHASES,
    PERMISSIONS.VIEW_OPERATING_PHASES,
